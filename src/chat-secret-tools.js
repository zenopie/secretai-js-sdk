...
/**
 * ChatSecretTools Class - Manages chat interactions with the LLM with tool binding support.
...
export class ChatSecretTools {
   ...
   * @returns {ChatSecretTools} - Returns the instance for chaining
   */
  bindTools(tools) {
  ...
  /**
   * Create a structured tool for function calling
   * @param {Function} func - The function to execute
   * @param {Object} config - Configuration for the tool
   * @returns {StructuredTool} - Returns a structured tool
   */
